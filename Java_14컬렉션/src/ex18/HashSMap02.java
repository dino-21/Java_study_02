...
public class HashSMap02 {
	public static void main(String[] args) {
		...
		/*
		 * HashMap과 HashSet은 순서를 보장하지 않는다.
		 * 입력 순서대로 출력되지 않는다.
		 * 데이터를 빠르게 저장하고 검색하기 위한 구조
		 * */
			 Map<Integer, String> map = new HashMap<>();
			// Map<Integer, String> map = new LinkedHashMap<>(); // 순서를 유지하고 싶다면
